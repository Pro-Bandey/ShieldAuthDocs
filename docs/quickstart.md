...
This quickstart explains how to add an example account to Shield Authenticator.
...
2. Click the scan icon at the top right corner of the window.
   ...
   ![click qr button](../src/assets/quickstart/add-qr.png)

3. Click and drag to draw a square that completely covers the QR code

   <video src=../src/assets/quickstart/qr-scan.webm" autoplay loop></video>
