...
stub: exportandimport
---

This guide explains how to export backups from Shield Authenticator and import previous backups to Shield Authenticator.

## Prerequisites

Install Shield Authenticator ([Firefox](https://addons.mozilla.org/en-US/firefox/addon/shield-authenticator/))

When you first install Shield Authenticator in Chrome, you should pin its icon to the toolbar.

![pin to toolbar](../src/assets/quickstart/pin-to-toolbar.png)

## Export backup file to local machine

![backup menu](../src/assets/quickstart/backup-menu1.png)
...
Unencrypted backup files use a standardized backup format that can be imported to other OTP clients. See [Standard Backup Format](?page=cloudbackup) to learn more.
...
Shield Authenticator can automatically backing up files to Google Drive, OneDrive and Dropbox. To enable cloud storage backup, click the service button to link to your cloud storage service account.

![backup menu](../src/assets/quickstart/backup-menu2.png)
...
![cloud backup](../src/assets/quickstart/cloud-backup.png)

## Import backup files

To import backup files to Shield Authenticator, open the **Backup** menu and click the **Import Backup** button.

![backup menu](../src/assets/quickstart/backup-menu1.png)

A new page will open with the following options: **Import Backup File**, **Import QR Image Backup**, and **Import Text Backup**.

![import backup](../src/assets/quickstart/import-backup.png)
...
- If you have a screenshot of a QR image, use **Import QR Image Backup**. You can select multiple images to import more than one account at a time.
   ...
   >
   > Google Authenticator supports exporting up to 10 accounts at one time. However, when importing to Shield Authenticator it is recommended to export five accounts at one time to prevent errors.
