...
![step1](../src/assets/edge-backup-screenshots/step1.PNG)
...
![step3](../src/assets/edge-backup-screenshots/step3.PNG)

4. Copy the result to notepad

![step4](../src/assets/edge-backup-screenshots/step4.PNG)

5. Save as a file ending in `.json`

![step5](../src/assets/edge-backup-screenshots/step5.PNG)
