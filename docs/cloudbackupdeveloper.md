...
If your application can import and export backups in this format please [raise an issue](https://github.com/Pro-Bandey/Shield-Authenticator/issues/new) so we can put you on [the list](?page=cloudbackup).
